mkdir ./estadonovo ./estadonovo/lib ./estadonovo/lib/armv7-a ./estadonovo/obj ./estadonovo/src ./estadonovo/dex ./estadonovo/res ./estadonovo/res/values ./estadonovo/assets ./src ./src/com ./src/com/jardimdanificado ./src/com/jardimdanificado/estadonovo/
...
python $NDK/build/tools/make_standalone_toolchain.py --arch arm64 --api 29 --install-dir=android_toolchain_ARM_API29
...
cp ../../libs/android-arm64/libraylib.a lib/armv7-a/libraylib.a
...
touch ./build.sh
cat <<EOF >./build.sh
../android_toolchain_ARM_API29/bin/aarch64-linux-android-gcc -c -I/usr/include/ $NDK/sources/android/native_app_glue/android_native_app_glue.c -o obj/native_app_glue.o -std=c99 -march=armv8-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -ffunction-sections -funwind-tables -fstack-protector-strong -fPIC -Wall -Wa,--noexecstack -Wformat -Werror=format-security -no-canonical-prefixes -DANDROID -DPLATFORM_ANDROID -D__ANDROID_API__=29 
...
../android_toolchain_ARM_API29/bin/arm-linux-androideabi-ar rcs obj/libnative_app_glue.a obj/native_app_glue.o

# Requires: obj/native_app_glue.o
# Creates: obj/libnative_app_glue.a

../android_toolchain_ARM_API29/bin/aarch64-linux-android-gcc -c ./src/estadonovo.c -o obj/estadonovo.o -I/usr/include/ -I./src/maquina/raylib -I$NDK/sources/android/native_app_glue -std=c99 -march=armv8-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -ffunction-sections -funwind-tables -fstack-protector-strong -fPIC -Wall -Wa,--noexecstack -Wformat -Werror=format-security -no-canonical-prefixes -DANDROID -DPLATFORM_ANDROID -D__ANDROID_API__=29 --sysroot=../toolchain_ARM_API29/sysroot

# Requires: estadonovo.c
# Creates: obj/estadonovo.o

../android_toolchain_ARM_API29/bin/aarch64-linux-android-gcc -o lib/armeabi-v8a/libestadonovo.so obj/estadonovo.o -shared -I. -I/usr/include/ -I./src/maquina/raylib -I$NDK/sources/android/native_app_glue -Wl,-soname,libestadonovo.so -Wl,--exclude-libs,libatomic.a -Wl,--build-id -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -Wl,--warn-shared-textrel -Wl,--fatal-warnings -u ANativeActivity_onCreate -L. -Lobj -Llib/armeabi-v8a -lraylib -lnative_app_glue -llog -landroid -lEGL -lGLESv2 -lOpenSLES -latomic -lc -lm -ldl

# Requires: obj/estadonovo.o
# Creates: lib/armeabi-v8a/libestadonovo.so

$ASDK/build-tools/28.0.1/aapt package -f -m -S res -J src -M AndroidManifest.xml -I $ASDK/platforms/android-29/android.jar

# Requires: AndroidManifest.xml, res/
# Creates: src/com/jardimdanificado/estadonovo/R.java

javac -verbose -source 1.7 -target 1.7 -d obj -bootclasspath /usr/lib/jvm/java-8-openjdk-amd64/jre/lib/jre/lib/rt.jar -classpath $ASDK/platforms/android-29/android.jar:obj -sourcepath src src/com/jardimdanificado/estadonovo/R.java src/com/jardimdanificado/estadonovo/NativeLoader.java
...
$ASDK/build-tools/28.0.1/aapt package -f -M AndroidManifest.xml -S res -A assets -I $ASDK/platforms/android-29/android.jar -F estadonovo.unsigned.apk dex
