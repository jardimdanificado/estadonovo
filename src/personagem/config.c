...
void PERSONAGEM_CONFIGSTART(PERSONAGEM* personagem)
{
    ...
    //4 - oculos 
    //5 - arma
    personagem->equip.chapeu.tipo = 1;
	personagem->equip.camisa.tipo = 2;
	personagem->equip.oculos.tipo = 4;
	personagem->equip.sapato.tipo = 3;
	personagem->equip.calca.tipo = 0;
    personagem->equip.arma.tipo = 5;
	personagem->equip.chapeu.ponteiro = 0;
	personagem->equip.camisa.ponteiro = 0;
	personagem->equip.oculos.ponteiro = 0;
	personagem->equip.sapato.ponteiro = 0;
