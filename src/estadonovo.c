...
int main(void)
{
    ...
    MQAddRenderModelToQueue(&data, MQCreateRenderModel(false,false,true,MQFindModel(data,"map0"),0,0,WHITE,(Vector3){0,0,0},0,"map0"));
    MQAddRenderModelToQueue(&data, MQCreateRenderModel(true,true,false,MQFindModel(data,"player"),0,0,COR_PELE0,data.game.player[0].position,data.game.player[0].rotation,"player0"));    
